...
whole_jou = ''
project_title = 'D2UX'
version_name = 'vent_ainew'
cad_name = 'D2UX_foot_V5'
case_out = r'G:\_HAVC_Project\D2UX\D2UX_vent\D2UX_vent_ainew'
...
CFD.mesh.rename_cell(zone_list=['ai', 'ai_duct', 'evap', 'fan', 'volute', 'filter', 'hc', 'distrib1', 'distrib2', 'cone'])
