...
version_name = 'V20-FH'
cad_name = 'GE2-rear3_V20-FH'
case_out = r'G:\GE2_REAR\GE2-rear-round3\GE2-rear-V20-FH'
...
CFD.setup.BC_outlet_vent(14.865, 'outlet_d')
CFD.setup.BC_outlet_vent(9.999, 'outlet_p')
